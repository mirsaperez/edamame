...
var edamameApi = `https://api.edamam.com/search?q=pizza&app_id=${apiId}&app_key=${apiKey}&from=0&to=3&calories=591-722&health=alcohol-free`
...
document.getElementById("btn").addEventListener("click",
    ...
    fetch(edamameApi).then(function (response) {
